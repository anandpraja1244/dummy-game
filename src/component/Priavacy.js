...
<h4  className=" ">Information shared such as:</h4>
  <li className="">1. Name</li>
  <li className="">2. Username</li>
  <li className="">3. Password</li>
  <li className="">4. Email address</li>
  <li className="">5. phone number</li>
  <li className="">6. Permanent account number</li>
  <li className="">7. Location/Address</li>
</ul>
...
<h4  className=" ">Information shared such as:</h4>
  ...
  <li className="">1. Data analysis</li>
  <li className="">2. Improving service quality</li>
  <li className="">3. Marketing purposes</li>
  <li className="">4. To identify individuals</li>
  <li className="">5. for legal purposes</li>
  <li className="">6. To prevent fraud and illegal activity</li>
</ul>
<p className='mb-2'>
